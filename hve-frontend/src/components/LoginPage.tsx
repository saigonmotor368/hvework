  ...
  return (
    <div className="min-h-[100dvh] bg-slate-50 flex flex-col justify-center py-6 sm:py-12 px-3 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl sm:text-2xl font-extrabold text-[#1D1D1F] tracking-tight">
          Hệ Thống Quản Lý Công Việc
        </h2>
        <p className="mt-1 text-sm text-gray-500">
          Huy Võ Education – Hệ thống điều hành &amp; Phê duyệt nội bộ
        </p>
      </div>
          ...
          {passwordChangeUser ? (
            ...
            >
              <div className="rounded-xl border border-blue-100 bg-blue-50 p-4 text-sm text-blue-900">
                ...
                <strong>{verificationEmail}</strong> và có hiệu lực trong 10
                phút.
              </div>
              {authError && (
